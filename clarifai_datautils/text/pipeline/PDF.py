...
class PDFPartition(BaseTransform):
    ...
    def __init__(self, ocr: bool = False, chunking_strategy: str = "basic", max_characters = MAX_CHARACTERS, overlap = None, overlap_all=True, **kwargs):
    ...
    def __call__(self, elements: List[str]) -> List[str]:
        ...
        for filename in elements:
            file_element = partition_pdf(filename=filename, strategy=self.strategy,
