...
from unstructured.cleaners.extract import extract_datetimetz, extract_email_address, extract_ip_address,extract_text_after,extract_ip_address_name ,extract_ordered_bullets, extract_text_before
...
class llamaindexwrapper(BaseTransform):
    ...
    def __init__(self, llama_extractor, max_nodes=MAX_NODES, skip_nodes=SKIP_NODES):
        ...
        assert (self.llama_extractor.llm.to_dict()['class_name'] == 'ClarifaiLLM'), "Only Clarifai LLM Models are allowed for extraction."
