...
from clarifai_datautils.multimodal import Pipeline, PDFExtraction
...
PDF_FILE_PATH = osp.abspath(osp.join(osp.dirname(__file__), "assets", "Multimodal_sample_file.pdf"))
